...
<div class="container" style="margin-top: 100px;">
    <br>
    <h1 class="text-center" style="font-size: 80px;">DELIVERY INFORMATION</h1>
    <p style="font-size: 30px;">For orders below 150php, add 20php for delivery fee.</p>
    <p style="font-size: 30px;">For orders with a minimum amount of 150php, add 10php for delivery fee.</p>
    <p style="font-size: 30px;">For orders above 150php, free delivery fee.</p>
    <p style="font-size: 30px;">For Urban Gardeners outside Cavite City, we offer delivery via lalamove.</p>
