                ...
                if($row['email_verified'] == NULL){
                    ...
                    if (isset($_POST['top_sale_submit'])) {
                        ...
                        if (mysqli_num_rows($select_cart) > 0) {
                            ...
                            $message[] = 'product added to reservation cart!';
                            echo '<script type="text/javascript">';
                            echo 'refreshPage()';  //not showing an alert box.
                            echo '</script>';
...
<section id="top-sale">
    <div class="container py-5">
        <h4 class="font-eduvic font-size-24" id="top-sale">Most Popular</h4>
        <hr>
        <!-- owl carousel -->
                        ...
                        <form method="post">
                            ...
                            if($total_quantity > 0) {
                                ...
                                if($item_reservation == 'Reservation'){
                                    echo PHP_EOL;
                                    echo '<a class="btn btn-success text-white font-size-12" onclick="popupValue()" id="open-edit" style="text-decoration: none" href="';
                                    echo $_SERVER['PHP_SELF'] . '?item_id_popup=';
                                    echo $item_id . PHP_EOL . '#top-sale">';
                                    echo 'Reservation </a>';
                                }
...
<section class="edit-form-container">
        ...
        <form action="" method="post">
            <div class="d-flex">
                <div class="col-sm-4  d-flex">
                    <img src="<?php echo $fetch_product['item_image'] ?? "./assets/products/product-1.jpg" ?>" style="margin-top: 20px; height: 150px;" alt="cart1" class="img-fluid">
                ...
                <div class="col-sm-8 text-left sizepopup w-25">
                    ...
                    <!-- Pots -->
                    <small>Pots:</small><br>
                        <input type="radio" name="potpopup" onclick="getWithoutPotPopup()" id="withoutPotPopup" value="withoutPotPopup" checked="checked">
                        <label for="withoutPotPopup" onclick="getWithoutPotPopup()">Without Pot<span></span></label>
                        <input type="radio" name="potpopup" onclick="getWithPotPopup()" id="withPotPopup" value="withPotPopup">
                        <label for="withPotPopup" onclick="getWithPotPopup()">With Pot<span></span></label>
            ...
            <div class="d-block">
                ...
                <input type="hidden" name="item_brand" value="<?php echo $fetch_product['item_brand'] ?? "Unknown" ?>">
                <input type="hidden" name="item_name" value="<?php echo $fetch_product['item_name'] ?? "Unknown" ?>">
                <input type="hidden" name="item_price" value="<?php echo $fetch_product['small_price'] ?? "Unknown" ?>">
                ...
                <?php
                            $item_id = $fetch_product['item_id'];
                            if($total_quantity > 0) {
                                echo '<button type="submit" onclick="popupValue()" name="top_sale_submit" class="btn btn-warning text-white">Add to Cart</button>';
    ...
    <script>
            ...
            function getWithPotPopup(){
                ...
                //alert("working");
                document.getElementById("withPotPopup").onclick = function(){
                    var value = $(this).val();
                    //alert(value);
                    ...
                    if(this.checked == true){
                        ...
                        if(sizeid === "small"){
                                ...
                                //alert($potvalue);
                                var withPotPopup = document.getElementById("withPotPopup");
                                var withoutPotPopup = document.getElementById("withoutPotPopup");
                                withPotPopup.checked = true;
                                withoutPotPopup.checked = false;
            ...
            function getWithoutPotPopup(){
                ...
                //alert("working");
                document.getElementById("withoutPotPopup").onclick = function(){
                    ...
                    if(this.checked == true){
                        ...
                        var potvalue =  $("#withoutPotPopup").val();
                        //alert(potvalue);
                        var withPotPopup = document.getElementById("withPotPopup");
                        var withoutPotPopup = document.getElementById("withoutPotPopup");
                        withPotPopup.checked = false;
                        withoutPotPopup.checked = true;
            ...
            $(document).on('change', '.sizepopup', function (){
                ...
                if($("input[name='potpopup']:checked").val() == "withPotPopup"){
                        sizeid = $("input[name='sizepopup']:checked").attr('id');
                        console.log(sizeid);
                ...
                }else if($("input[name='potpopup']:checked").val() == "withoutPotPopup"){
                    sizeid = $("input[name='sizepopup']:checked").attr('id');
                    console.log(sizeid);
                    if(sizeid === "smallpopup"){
