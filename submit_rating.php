...
if(isset($_POST["rating_data"]))
{
	...
	(item_id, item_name, user_name, first_name, last_name, user_image, user_rating, user_review, datetime) 
	VALUES (:item_id, :item_name, :user_name, :first_name, :last_name, :user_image, :user_rating, :user_review, :datetime)
	";
...
if(isset($_POST["action"]))
{
    ...
    $query = "
	SELECT * FROM review_table WHERE item_id = '$item_id'
