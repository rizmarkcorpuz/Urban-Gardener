...
?>
        ...
        <?php
                    ...
                    <?php
                        ...
                        if($request === 'First In'){
                            $checkout_query = mysqli_query($conn, "SELECT DISTINCT order_number, user_id, item_status FROM `transaction` WHERE (item_status = 'Completed' or item_status = 'Cancelled') ORDER BY date") or die('query failed');
                        }elseif($request === 'First Out'){
                            $checkout_query = mysqli_query($conn, "SELECT DISTINCT order_number, user_id, item_status FROM `transaction` WHERE (item_status = 'Completed' or item_status = 'Cancelled') ORDER BY date DESC") or die('query failed');
                        }else{
