...
?>
        ...
        <?php
            ...
            $checkout_query = mysqli_query($conn, "SELECT DISTINCT order_number, user_id FROM `checkout` WHERE date_delivery = '$request' ORDER BY order_number") or die('query failed');
            $grand_total = 0;
