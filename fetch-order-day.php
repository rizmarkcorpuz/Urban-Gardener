...
?>
        ...
        <?php
            ...
            $select_checkouts = mysqli_query($conn, "SELECT DISTINCT order_number, user_id FROM `checkout` WHERE user_id='$user_id' AND date_delivery = '$month' AND date_delivery_day = '$request' ORDER BY order_number");
            $grand_total = 0;
